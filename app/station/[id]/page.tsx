...
export default async function Station({ params }: { params: Promise<{ id: string }> }) {
  ...
  return <PortalShell org={d.station} campaign={collections[0]} campaigns={collections} userEmail={d.user.email || ""} organizationId={id} platform={d.admin}><div className="station-app" style={{ '--station-color': color } as React.CSSProperties}>
