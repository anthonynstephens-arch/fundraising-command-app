...
export function MacacStorefront({ campaign }: { campaign?: Campaign | null }) {
  ...
  return <div className="macac-store" id="macac-top">
    ...
    <main>
      <section className="macac-hero" aria-labelledby="macac-title"><div className="macac-hero-copy"><p className="macac-label">MICHIGAN’S COLLEGE ADMISSION COUNSELING COMMUNITY.</p><h1 id="macac-title">Connected<br/><em>by purpose.</em></h1><p className="macac-lead">Apparel and everyday essentials for the professionals helping students navigate the path to college.</p><a className="macac-cta macac-cta-light" href="#macac-collection">Explore the collection <span aria-hidden="true">↗</span></a><div className="macac-hero-note"><span>01 — THE MACAC COLLECTION</span><span>Apparel & everyday essentials</span></div></div><div className="macac-hero-media"><Image src="/brand/macac/polo.webp" alt="Navy MACAC polo with white embroidered mark" fill priority sizes="(max-width: 700px) 100vw, 50vw"/><div className="macac-image-caption"><span>THE SIGNATURE POLO</span><span>Navy / White</span></div></div></section>
      <section className="macac-intro" id="macac-story"><p className="macac-label">THE MACAC COMMUNITY.</p><h2>Supporting students.<br/><span>Connecting professionals.</span></h2><p>From campus visits to conference conversations, carry your connection to Michigan’s college admission counseling community.</p></section>
