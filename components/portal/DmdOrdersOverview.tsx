...
export default function DmdOrdersOverview({orders,error}:{orders:DmdOrder[];error?:boolean}){
  return <section className="agency-card dmd-orders-overview">
    <header><div><h2>DMD Shopify Orders</h2><p>All orders under the DMD business account, plus orders placed through the private portal</p></div><Link href="/stores/dmd/private">Shop private collection →</Link></header>
