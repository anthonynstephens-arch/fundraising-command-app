  ...
  return <div className="agency-shell">
    <aside className="agency-sidebar">
      ...
      <div className={"agency-side-bottom "+(menuOpen?"mobile-open":"")}>
        ...
        <div className="agency-menu-sync"><span>↻</span><div><small>LAST SYNCED</small><strong>{lastSynced?new Date(lastSynced).toLocaleString():(stationMode ? "Not synced yet" : "No webhook yet")}</strong></div></div>
