...
const steps=[
 ...
 {title:'Know what’s available',body:'Payout Engine separates earned, pending, paid and available funds. Request controls depend on your role and eligible balance.',route:'/payouts',target:'.agency-kpis',action:'Open Payout Engine',symbol:'$'},
